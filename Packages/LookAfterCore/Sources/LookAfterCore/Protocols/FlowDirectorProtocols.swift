...
/// Implemented in LookAfterAI (milestone D2.4+). UI and widgets observe `surface`.
@MainActor
...
///
/// Defined in LookAfterCore so CloudKit or other backends can be injected from any package
