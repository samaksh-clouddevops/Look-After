...
| PERF-018 | **Fixed** | Near-complete SharedFormatters migration (stores, persistence, AI, widgets, planning parsers) |
...
| PERF-016′ | **Fixed** | Remaining VM firstIndex assigns use `applyInMemoryTaskUpdate` / `taskIndex` |
