...
> **Look After override:** Do **not** retheme the shipping app to the teal/orange table below.
> Live tokens stay in `LookAfterCore` `DesignSystem` (lime accent, existing surfaces).
> Use this file for layout/UX rules and checklists; color/type suggestions are advisory only.
