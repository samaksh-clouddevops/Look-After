...
FILES=(
  "LifeOS-iOS.entitlements"
  "LifeOSWidget/LifeOSWidget.entitlements"
...
replace_in_file "LifeOS-iOS.entitlements" "s|${OLD_GROUP}|${NEW_GROUP}|g"
replace_in_file "LifeOSWidget/LifeOSWidget.entitlements" "s|${OLD_GROUP}|${NEW_GROUP}|g"
...
if [[ "$UPDATE_FIREBASE" -eq 1 ]]; then
  replace_in_file "GoogleService-Info.plist" \
