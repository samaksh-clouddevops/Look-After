...
enum LifeOSTab: Int, CaseIterable, Identifiable {
    case briefing
    case timeline
    case work
    case brain
...
struct LifeOSBottomNav: View {
    @Binding var selection: LifeOSTab
    ...
    private func tabButton(_ tab: LifeOSTab) -> some View {
